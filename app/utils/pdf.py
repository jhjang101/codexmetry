...
def save_pdf_from_html(template_path: str, context: dict, filename: str, subfolder: str):
    ...
    context_data['physical_root'] = app_path # For CSS resolution
    context_data['physical_upload_root'] = current_app.config['UPLOAD_FOLDER'] # For Image resolution
    ...
    # 4. Target the root-level data/uploads folder
